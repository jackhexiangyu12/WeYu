/**
 * Notes: 云函数业务主逻辑
 * Ver : CCMiniCloud Framework 2.8.1 ALL RIGHTS RESERVED BY he_xiang_yu (wechat)
...
function beforeApp(method) {
	switch (method) {
		case 'demo': {
			return appUtil.handlerAppErr('本系统仅为用户体验演示，后台提交的操作均不生效！如有需要请联系作者微信he_xiang_yu', appCode.LOGIC);
		}
	}
